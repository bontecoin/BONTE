 ...
 * Bontecoin system. There are three: the main network on which people trade goods
...
public:
    ...
    int BontecoinBadBlockTime() const { return nBontecoinBadBlockTime; }
    int BontecoinBadBlocknBits() const { return nBontecoinBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nBontecoinBadBlockTime;
    unsigned int nBontecoinBadBlocknBits;
