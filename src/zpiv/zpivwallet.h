...
#ifndef Bontecoin_ZBONTEWALLET_H
#define Bontecoin_ZBONTEWALLET_H
...
public:
    CzBONTEWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBONTE(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBONTE(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //Bontecoin_ZBONTEWALLET_H
