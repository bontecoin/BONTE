...
/** Utility functions used by the Bontecoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Bontecoin addresses in monospace font
...
// Parse "bontecoin:" URI into recipient object, return true on successful parsing
