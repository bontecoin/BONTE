...
/** Utility functions used by the Altecoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Altecoin addresses in monospace font
...
// Parse "altecoin:" URI into recipient object, return true on successful parsing
