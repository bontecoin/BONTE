...
/* Altecoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Altecoin"
#define QAPP_ORG_DOMAIN "altecoin.org"
#define QAPP_APP_NAME_DEFAULT "Altecoin-Qt"
#define QAPP_APP_NAME_TESTNET "Altecoin-Qt-testnet"
