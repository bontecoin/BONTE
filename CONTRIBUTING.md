Contributing to Bontecoin Core
============================

The Bontecoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/bontecoin-bonte/bontecoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Bontecoin Core project, and is not to be
confused with overall Bontecoin Network Protocol consensus changes.

Whether a pull request is merged into Bontecoin Core rests with the project merge
...
Patches that change Bontecoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Bontecoin consensus, it must have been
...
The project leader is the release manager for each Bontecoin Core release.
