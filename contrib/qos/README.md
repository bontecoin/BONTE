...
This means one can have an always-on altecoind instance running, and another local altecoind/altecoin-qt instance which connects to this node and receives blocks from it.
