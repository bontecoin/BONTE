...
This means one can have an always-on bontecoind instance running, and another local bontecoind/bontecoin-qt instance which connects to this node and receives blocks from it.
