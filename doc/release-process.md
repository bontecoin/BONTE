...
* Update translations (ping Fuzzbawls on Discord) see [translation_process.md](https://https://github.com/bontecoin/BONTE/blob/master/doc/translation_process.md#synchronising-translations).
* Update manpages, see [gen-manpages.sh](https://https://github.com/bontecoin/BONTE/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/bontecoin/gitian.sigs.git
    git clone https://https://github.com/bontecoin/BONTE-detached-sigs.git
...
- Detached signatures will then be committed to the [bontecoin-detached-sigs](https://https://github.com/bontecoin/BONTE-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://https://github.com/bontecoin/BONTE/releases/new) with a link to the archived release notes.
