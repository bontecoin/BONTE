...
This document provides guidelines for internationalization of the Altecoin Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to Altecoin network</source>
        <translation>
            <numerusform>%n active connection to Altecoin network</numerusform>
            <numerusform>%n active connections to Altecoin network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `altecoin_en.ts` remains unchanged.
