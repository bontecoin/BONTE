...
"""Verify that starting altecoin with -h works as expected."""
import subprocess

from test_framework.test_framework import AltecoinTestFramework
from test_framework.util import assert_equal

class HelpTest(AltecoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start altecoin with -h for help text")
        ...
        self.log.info("Start altecoin with -version for version information")
