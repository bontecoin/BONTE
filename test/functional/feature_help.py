...
"""Verify that starting bontecoin with -h works as expected."""
import subprocess

from test_framework.test_framework import BontecoinTestFramework
from test_framework.util import assert_equal

class HelpTest(BontecoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bontecoin with -h for help text")
        ...
        self.log.info("Start bontecoin with -version for version information")
